...
api-evangelist-provenance:
  ...
  method: searched
  source: https://github.com/signalwire/signalwire-claude/blob/main/skills/signalwire/SKILL.md
  note: >-
    Saved verbatim. SignalWire publishes this as the 'signalwire-builder' Claude Code plugin
    (/plugin marketplace add signalwire/signalwire-claude). Nothing in it was authored by
    API Evangelist.
-->
